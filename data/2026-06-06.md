...
### [7] [KV-Control: Parameter-Efficient K/V Injection for Trajectory-Controlled Text-to-Motion](https://arxiv.org/abs/2606.05624)
...
### [9] [FontFusion: Enhancing Generative Text in Diffusion Models with Typographic Conditioning](https://arxiv.org/abs/2606.06066)
...
### [10] [Recovering Physically Plausible Human-Object Interactions from Monocular Videos](https://arxiv.org/abs/2606.05359)
...
### [11] [SC-MFJ: A Simple Haptic Quality Metric for Medical Image Segmentation](https://arxiv.org/abs/2606.06199)
...
### [314] [SET: Stream-Event-Triggered Scheduling for Efficient CUDA Graph Pipelines](https://arxiv.org/abs/2606.05495)
...
### [315] [Latent Reasoning Guidance for Parallel Code Translation](https://arxiv.org/abs/2606.05518)
...
### [316] [PoCQ: Proof of Contribution Quality as a Lightweight Blockchain Consensus for Secure Federated Learning](https://arxiv.org/abs/2606.05642)
...
### [317] [IN2P3 Computing Center 2024 Workload Dataset](https://arxiv.org/abs/2606.05914)
...
### [318] [Beyond Greedy Chunking: SLO-Aware Sliding-Window Scheduling for LLM Inference](https://arxiv.org/abs/2606.05933)
...
### [319] [Demystifying NVSHMEM: A System-Level Analysis on Symmetric Memory and Device-Initiated Operations in GPU Communication](https://arxiv.org/abs/2606.05951)
...
### [320] [LLM-Based Porting of Optimized C++ to CUDA Through Deoptimization and Reoptimization](https://arxiv.org/abs/2606.06063)
...
### [321] [Discrete Incremental Voting: New Bounds for General Graphs and Expanders](https://arxiv.org/abs/2606.06381)
...
### [322] [On GPU Implementation for Multi-Precision Integer Division](https://arxiv.org/abs/2606.06386)
...
### [323] [CarbonSim: A Lifecycle-Aware Framework for Evaluating Carbon Tradeoffs in Hardware Upgrade Decisions](https://arxiv.org/abs/2606.06438)
...
### [324] [Learning and Inferring Multiphase Flow Dynamics in Porous Media using Scientific Machine Learning: Application to the "FluidFlower" CO2 Injection Experiment](https://arxiv.org/abs/2606.05448)
...
### [325] [Preparing for the Next Carrington: Spatiotemporal Agent-Based Modeling for Safeguarding Satellite Infrastructure Under Extreme Space Weather Disturbances](https://arxiv.org/abs/2606.05732)
...
### [326] [Multi-Condition Guided Diffusion Model for Controllable Elastic Parameter Synthesis](https://arxiv.org/abs/2606.05751)
...
### [327] [Leveraging MTG-FCI fire observations for event-based fire behavior monitoring from near-real-time operation to seasonal analysis](https://arxiv.org/abs/2606.06016)
...
TL;DR: A new Fire Event Tracker groups 10-minute MTG/FCI hotspot detections into persistent fire events, estimates their evolution over time, and proves useful for both live wildfire monitoring and retrospective fire analysis.


<details>
  <summary>Details</summary>
Motivation: Operational wildfire management needs timely and coherent estimates of fire behavior such as energy release and spread rate. Although MTG/FCI provides 10-minute active fire observations, these hotspot detections must be linked into meaningful fire events before they can support decision-making and modeling.

Method: The paper proposes a Fire Event Tracker (FET) that performs spatio-temporal clustering of hotspot detections from the LSA-SAF FCI active fire product, assigns persistent fire-event IDs, and updates event geometry, fire radiative power, and rate of spread every 10 minutes for both near-real-time and retrospective workflows.

Result: FET was applied to the 2025 Mediterranean FCI hotspot archive and in near-real-time operations in Portugal and the 2025 SILEX/EUBURN campaign. The results indicate that the tracker provides a consistent description of fire evolution and can also initialize coupled FOREFIRE-MesoNH plume-forecast simulations.

Conclusion: Event-based clustering of MTG/FCI active fire detections can reliably reconstruct fire evolution and support both real-time wildfire operations and retrospective seasonal analysis.
...
### [328] [MODIS Thermal Infrared Sounding (MOTIS): Estimating Tropical Cyclone Central Pressure from Warm-Core Anomalies](https://arxiv.org/abs/2606.06408)
*Jinghuai Yao,Chi Yan Kwok,Puyuan Du,Yubo Wang,Derrick Herndon*

Main category: physics.ao-ph

TL;DR: MOTIS uses MODIS infrared measurements of tropical cyclone eye warm cores plus linear regression to estimate central pressure very accurately for intense, clear-eye storms, improving on existing methods and offering strong potential for future operational use.


<details>
  <summary>Details</summary>
Motivation: Existing methods for estimating tropical cyclone central pressure have limitations, especially for intense storms, while the combined high spatial resolution and sounding capability of MODIS has been largely overlooked for this purpose.

Method: The paper develops the MODIS Thermal Infrared Sounding (MOTIS) framework, which applies instrument-specific preprocessing to MODIS thermal infrared data, measures warm-core anomalies in tropical cyclone eyes, and uses multiple linear regression to estimate central sea-level pressure.

Result: For high-intensity tropical cyclones with clear eyes, MOTIS achieves r^2 = 0.945 and RMSE = 4.3 hPa with a mean central pressure of 937 hPa. The authors also build a dataset of 3288 estimates, including 1082 clear-eye cases, from 2002 to 2025 and show that it can substantially reduce Best Track pressure uncertainty when direct observations are unavailable.

Conclusion: MOTIS demonstrates that MODIS infrared sounding can estimate tropical cyclone central pressure accurately for intense storms with clear eyes, outperforming prior methods and offering a path for future real-time applications with next-generation sounders.
...
### [329] [The Evaluation Blind Spot: A Stereological Theory of Benchmark Coverage for Large Language Models](https://arxiv.org/abs/2606.05169)
*Jason Z Wang*
...
### [330] [ERRORQUAKE: Heavy-Tailed Error Severity Distributions in Open-Weight Large Language Models](https://arxiv.org/abs/2606.05170)
*Jason Z Wang*
...
### [331] [Staged Factorial Screening for Budget-Constrained Micro-Pretraining](https://arxiv.org/abs/2606.05186)
...
### [332] [PyCC.id: A package for hypothesis-driven equation discovery with structural identifiability](https://arxiv.org/abs/2606.05191)
*Federico J. Gonzalez*
...
### [333] [Balancing Image Compression and Generation with Bootstrapped Tokenization](https://arxiv.org/abs/2606.05552)
...
### [334] [Temporal Preference Concepts and their Functions in a Large Language Model](https://arxiv.org/abs/2606.05194)
...
### [335] [State commitment learning: training language models to distinguish computation from memory](https://arxiv.org/abs/2606.05201)
...
### [336] [Gradient Descent with Large Step Size Restores Symmetry in Deep Linear Networks with Multi-Pathway](https://arxiv.org/abs/2606.05219)
...
### [337] [Zero-Copy Semantic Contagion: An In-Memory Streaming Architecture for Evolving Attention Graphs](https://arxiv.org/abs/2606.05733)
*Kabir Murjani*
...
### [338] [Differentiable Efficient Operator Search](https://arxiv.org/abs/2606.05232)
...
### [339] [DiffSlack: Learning under Nonlinear Inequality Constraints via Learnable Slack Variables](https://arxiv.org/abs/2606.05247)
...
### [340] [Alpha-RTL: Test-Time Training for RTL Hardware Optimization](https://arxiv.org/abs/2606.05253)
...
### [341] [Flash-WAM: Modality-Aware Distillation for World Action Models](https://arxiv.org/abs/2606.05254)
...
### [342] [Scaling Laws for Behavioral Foundation Models over User Event Sequences](https://arxiv.org/abs/2606.05257)
...
### [343] [Policy-Conditioned Counterfactual Credit for Verifiable Reinforcement Learning of Long-Horizon Language Agents](https://arxiv.org/abs/2606.05263)
*Renwei Meng*
...
### [344] [REGEN: Reference-Guided Synthetic Multivariate Time Series Generation for Forecasting](https://arxiv.org/abs/2606.05264)
...
### [345] [Data-efficient flood depth prediction through domain-aware coreset selection and tabular foundation models](https://arxiv.org/abs/2606.05265)
...
### [346] [Sharp Low-Degree Thresholds for Planted-vs-Planted Testing](https://arxiv.org/abs/2606.05266)
...
### [347] [Learning Manifold and Itô Dynamics with Branched Neural Rough Differential Equations](https://arxiv.org/abs/2606.05272)
...
### [348] [Anomaly Detection for Electro-Hydrostatic Actuators using LSTM Autoencoder](https://arxiv.org/abs/2606.05274)
...
### [349] [Agentic Monte Carlo: Simulating Reinforcement Learning for Black-Box Agents](https://arxiv.org/abs/2606.05296)
...
### [350] [Statistically Reliable LLM-Based Ranking Evaluation via Prediction-Powered Inference](https://arxiv.org/abs/2606.05308)
*Abhishek Divekar*
...
### [351] [Multimarginal flow matching with optimal transport potentials](https://arxiv.org/abs/2606.05327)
...
### [352] [A prism hierarchy of learning regimes in large linear autoencoders](https://arxiv.org/abs/2606.05335)
...
### [353] [PJ-RoPE: A Fourier-Jet-Affine Position Space for Relative Attention](https://arxiv.org/abs/2606.05345)
*Yaobo Zhang*
...
### [354] [Mamba-Assisted Non-Markovian Closure for Reduced-Order Modeling](https://arxiv.org/abs/2606.05371)
...
### [355] [Evidence-Guided Neural Architecture Selection under Uncertainty for Subject-Specific Blood Glucose Forecasting](https://arxiv.org/abs/2606.05373)
...
### [356] [SHALA-LLM: Smartly Handling Ambiguous Labels in Aligning LLMs](https://arxiv.org/abs/2606.05376)
...
### [357] [Pattern Selectivity is Not Task-Causal Structure: A Cross-Architecture Mechanistic Study of Composed-Task Circuits in 1B-Class Language Models](https://arxiv.org/abs/2606.05378)
*Yongzhong Xu*
...
### [358] [Generalized TV--$\ell_p$ Structured Priors for Bayesian $T_1$ Mapping](https://arxiv.org/abs/2606.05381)
...
### [359] [Trust, but Don't Verify: Epistemic Blind Spots in LLM Source Evaluation](https://arxiv.org/abs/2606.05403)
...
### [360] [CausalPOI: Spatio-Temporal Graph-Based Causal Modeling for Cold-Start POI Check-in Forecasting](https://arxiv.org/abs/2606.05413)
...
### [361] [Selective-Advantage Entropy-Adaptive Horizon GRPO: Asymmetric Token-Level Discounting for Efficient Reinforcement Learning of Language Models](https://arxiv.org/abs/2606.05434)
...
### [362] [DP-MacAdam: Differentially Private Mechanism with Adaptive Clipping and Adaptive Momentum](https://arxiv.org/abs/2606.05435)
...
### [363] [Sharp First-Order Lower Bounds for Higher-Order Smooth Nonconvex Optimization](https://arxiv.org/abs/2606.05438)
*Dongruo Zhou*
...
### [364] [GOTabPFN: From Feature Ordering to Compact Tokenization for Tabular Foundation Models on High-Dimensional Data](https://arxiv.org/abs/2606.05441)
...
### [365] [Towards Unified and Data-Efficient Prognostics and Health Management with Tabular Foundation Models](https://arxiv.org/abs/2606.05481)
...
### [366] [Learned Subspace Compression for Communication-Efficient Pipeline Parallelism](https://arxiv.org/abs/2606.05484)
...
### [367] [LEVANTE-bench: Multi-Scale Comparison of VLMs to Children Using Cognitive Tasks (or, "Is Your VLM Smarter Than a 5th Grader?")](https://arxiv.org/abs/2606.05497)
...
### [368] [Dominant-Layer ZO: A Single Layer Dominates Zeroth-Order Fine-Tuning of LLMs](https://arxiv.org/abs/2606.05516)
...
### [369] [What Objects Enable, Not What They Are: Functional Latent Spaces for Affordance Reasoning](https://arxiv.org/abs/2606.05533)
...
### [370] [Less is MoE: Trimming Experts in Domain-Specialist Language Models](https://arxiv.org/abs/2606.05538)
...
### [371] [Representation Learning Enables Scalable Multitask Deep Reinforcement Learning](https://arxiv.org/abs/2606.05555)
...
### [372] [Field Validation of a Multi-Resolution ConvLSTM Framework for Retaining Wall Deformation Prediction](https://arxiv.org/abs/2606.05556)
...
### [373] [Autoregressive Diffusion World Models for Off-Policy Evaluation of LLM Agents](https://arxiv.org/abs/2606.05558)
...
### [374] [CLaaS: Continual learning as a service for sample efficient online learning](https://arxiv.org/abs/2606.05559)
...
### [375] [AsyncWebRL: Efficient Multi-Step RL for Visual Web Agents](https://arxiv.org/abs/2606.05597)
...
### [376] [Mitigating the Curse of Dimensionality in Uniform Convergence of Deep Neural Networks via Smooth Activations](https://arxiv.org/abs/2606.05599)
...
### [377] [From Prediction to Self: Developmental Conditions for Agency in Minimal Neural Systems](https://arxiv.org/abs/2606.05605)
*Evan Ye*
...
### [378] [Cross-Epoch Adaptive Rollout Optimization for RL Post-Training](https://arxiv.org/abs/2606.05606)
...
### [379] [StableRCA: Robust Graph-Agnostic Mechanism-Level Root Cause Analysis](https://arxiv.org/abs/2606.05636)
...
### [380] [Q-GNN: Query-Conditioned Graph Neural Networks with Type Awareness for Knowledge Graph Completion](https://arxiv.org/abs/2606.05639)
...
### [381] [Two-Way Is Better Than One: Bidirectional Alignment with Cycle Consistency for Exemplar-Free Class-Incremental Learning](https://arxiv.org/abs/2606.05675)
...
### [382] [Causal Modeling of Selection in Evolution](https://arxiv.org/abs/2606.05689)
...
### [383] [Benchmarking Counterfactual Prediction in Epidemic Time Series with Time-Varying Interventions](https://arxiv.org/abs/2606.05692)
...
### [384] [MolE-RAG: Molecular Structure-Enhanced Retrieval-Augmented Generation for Chemistry](https://arxiv.org/abs/2606.05693)
...
### [385] [Revisiting Prototype Rehearsal for Exemplar-Free Continual Learning: Manifold-Aware Boundary Sampling with Adaptive Class-Balanced Loss](https://arxiv.org/abs/2606.05695)
*Hongye Xu,Bartosz Krawczyk*
...
### [386] [Intercomparison of Machine Learning Algorithms for Remote Sensing-based In-season Crop Mapping](https://arxiv.org/abs/2606.05731)
...
### [387] [Beyond Soft Masks: Hard-Perturbation Mixup Explainer for Robust GNN Explainability](https://arxiv.org/abs/2606.05756)
...
### [388] [Domain-Adapted Small Language Models with Hybrid Post-Processing: Achieving Cost-Efficient, Low-Latency Multi-Label Structured Prediction via LoRA Fine-Tuning on Scarce Data](https://arxiv.org/abs/2606.05781)
...
### [389] [Causal Longitudinal Prior-Fitted Networks for Counterfactual Outcome Prediction](https://arxiv.org/abs/2606.05797)
...
### [390] [CaliDist: Calibrating Large Language Models via Behavioral Robustness to Distraction](https://arxiv.org/abs/2606.05799)
...
### [391] [SALT: When More Rollouts Don't Help in Group-Based Policy Optimization and How to Make Them Matter](https://arxiv.org/abs/2606.05800)
...
### [392] [Robust and sparse support vector machine via hybrid truncated loss for supervised classification](https://arxiv.org/abs/2606.05814)
...
### [393] [Consistency Training Along the Transformer Stack](https://arxiv.org/abs/2606.05817)
...
### [394] [GenAutoML: An Agentic Framework for Dynamic Architecture Generation and Optimization in Time-Series Analysis](https://arxiv.org/abs/2606.05860)
...
### [395] [Deciphering Two Training Clocks in Grokking via Deep Linear Network Theory with Conditional ReLU Reduction](https://arxiv.org/abs/2606.05863)
...
### [396] [TS-ICL: A Flexible Time-Indexed Foundation Model for Time Series via In-Context Learning](https://arxiv.org/abs/2606.05878)
...
### [397] [When Denser Credit Is Not Enough: Evidence-Calibrated Policy Optimization for Long-Horizon LLM Agent Training](https://arxiv.org/abs/2606.05885)
...
### [398] [High-Dimensional Theory of LoRA Fine-Tuning in a Solvable Attention Model](https://arxiv.org/abs/2606.05899)
...
### [399] [Addressing Imbalance in Multi-Label Data via Label-Specific Distance-based Oversampling](https://arxiv.org/abs/2606.05927)
...
### [400] [Short paper: Models in the dark -- Rectification and erasure under GDPR in ML supply chains](https://arxiv.org/abs/2606.05946)
...
### [401] [Dead Directions: Geometric Singular Learning](https://arxiv.org/abs/2606.05957)
...
### [402] [Steering Vectors are an Adversarial Attack Surface](https://arxiv.org/abs/2606.05958)
...
### [403] [LLM Explainability with Counterfactual Chains and Causal Graphs](https://arxiv.org/abs/2606.05972)
...
### [404] [Compress-Distill: Reasoning Trace Compression for Efficient Knowledge Distillation](https://arxiv.org/abs/2606.05988)
...
### [405] [HoT-SSM:Higher-order Temporal Knowledge Graph Reasoning with State Space Models for Health Care](https://arxiv.org/abs/2606.05994)
...
### [406] [Diffusion Models for Adaptive Sequential Data Generation](https://arxiv.org/abs/2606.06007)
...
### [407] [Adaptive Oscillatory-State Alignment for Time Series Forecasting](https://arxiv.org/abs/2606.06010)
...
### [408] [OPRD: On-Policy Representation Distillation](https://arxiv.org/abs/2606.06021)
...
### [409] [Catastrophic Forgetting as Accessibility Collapse: A Three-Level Framework for Knowledge Persistence in Continual Learning](https://arxiv.org/abs/2606.06032)
...
### [410] [When Good Enough Is Optimal: Multiplication-Only Matrix Inversion Approximation for Quantized Gated DeltaNet](https://arxiv.org/abs/2606.06034)
...
### [411] [Online KL-Regularized Reinforcement Learning with Function Approximation under Misspecification](https://arxiv.org/abs/2606.06053)
...
### [412] [MDP-GRPO: Stabilized Group Relative Policy Optimization for Multi-Constraint Instruction Following](https://arxiv.org/abs/2606.06058)
...
### [413] [On Advantage Estimates for Max@K Policy Gradients](https://arxiv.org/abs/2606.06080)
...
### [414] [OrderGrad: Optimizing Beyond the Mean with Order-Statistic Policy Gradient Estimation](https://arxiv.org/abs/2606.06096)
...
### [415] [A Sliced-Wasserstein Framework on Correlation Matrices for EEG Decoding](https://arxiv.org/abs/2606.06104)
...
### [416] [Adaptive state-action abstractions via rate-distortion](https://arxiv.org/abs/2606.06123)
*Fernando E. Rosas*
...
### [417] [Tight list replicability bounds via a novel sphere covering theorem](https://arxiv.org/abs/2606.06148)
...
### [418] [Trust-Aware Predictive Emissions Monitoring for Gas Turbine Fleets with Limited Labelled Data](https://arxiv.org/abs/2606.06156)
...
### [419] [On the training of physics-informed neural operators for solving parametric partial differential equations](https://arxiv.org/abs/2606.06164)
...
### [420] [Learning to model pediatric asthma exacerbation from multiple risk factors: a case study in coastal Virginia](https://arxiv.org/abs/2606.06174)
...
### [421] [Learning to Route LLMs from Implicit Cost-Performance Preferences via Meta-Learning](https://arxiv.org/abs/2606.06178)
...
### [422] [A Machine Learning-Based Framework for Discovering Huntington's Disease Stages: Integrating Graph Representation Learning and clustering to Uncover Progression Dynamics in Longitudinal Enroll-HD Dataset](https://arxiv.org/abs/2606.06196)
...
### [423] [Non-Negative Matrix Factorization for Event Data](https://arxiv.org/abs/2606.06205)
*Raphaël Romero*
...
### [424] [Design a Reliable LLM-Integrated Interface for Mortality Forecasting](https://arxiv.org/abs/2606.06235)
*Thi Kim Ngan Nguyen*
...
### [425] [Tracing the Oracle: Improving Diffusion Timestep Scheduling for 3D CT Reconstruction](https://arxiv.org/abs/2606.06236)
...
### [426] [Generative Criticality in Large Language Model Temperature Scaling](https://arxiv.org/abs/2606.06238)
...
### [427] [Your GFlowNet Secretly Learns an Optimal Transport Plan](https://arxiv.org/abs/2606.06272)
...
### [428] [PAC-Bayesian Adversarially Robust Generalization for Message Passing Graph Neural Networks: A Sensitivity Analysis](https://arxiv.org/abs/2606.06293)
...
### [429] [Reactive Flux Matching: Mechanism Discovery and Adaptive Sampling of Rare Events](https://arxiv.org/abs/2606.06295)
...
### [430] [Tangram: Unlocking Non-Uniform KV Cache for Efficient Multi-turn LLM Serving](https://arxiv.org/abs/2606.06302)
...
### [431] [Plug-and-Play Guidance for Discrete Diffusion Models via Gradient-Informed Logit Correction](https://arxiv.org/abs/2606.06303)
...
### [432] [Learning What to Forget: Improving LLM Unlearning via Learned Token-Level Importance](https://arxiv.org/abs/2606.06320)
...
### [433] [PAMF: Prior-Aware Multimodal Fusion for Incomplete Time Series Data](https://arxiv.org/abs/2606.06328)
...
### [434] [Efficient Mean Curvature Computation on High-Dimensional Data Manifolds](https://arxiv.org/abs/2606.06329)
...
### [435] [Subspace-Aware Sparse Autoencoders for Effective Mechanistic Interpretability](https://arxiv.org/abs/2606.06333)
...
### [436] [Quantifying the Privacy of Counterfactuals by Leveraging Membership Inference Attacks Against Synthetic Data](https://arxiv.org/abs/2606.06334)
...
### [437] [Bridging Domain Expertise and Generalization for Performance Estimation](https://arxiv.org/abs/2606.06335)
...
### [438] [Equivariant Neural Belief Propagation](https://arxiv.org/abs/2606.06344)
...
### [439] [Performance Evaluation of GraphCast for Medium-Range Weather Forecasting over Brazil](https://arxiv.org/abs/2606.06348)
...
### [440] [Maximising the Set-Piece Return: Optimising Football Corner Tactics with Graph Reinforcement Learning](https://arxiv.org/abs/2606.06353)
...
### [441] [In-Context Multiple Instance Learning](https://arxiv.org/abs/2606.06458)
...
### [442] [End-to-End Subgraph Detection with GraphDETR](https://arxiv.org/abs/2606.06364)
...
### [443] [Learned Response-Field Inertia Operator for HEC-RAS 2D Water-Surface Elevation Prediction](https://arxiv.org/abs/2606.06385)
...
### [444] [Proper Scoring Rules for Right-Censored Survival Data](https://arxiv.org/abs/2606.06393)
...
### [445] [The Post-GCN Decade Revisited: Curvature-Stratified Evaluation of Relational Learning](https://arxiv.org/abs/2606.06397)
...
### [446] [Double Preconditioning (DoPr): Optimization for Test-Time Performance, not Validation Loss](https://arxiv.org/abs/2606.06418)
...
### [447] [Causal Atlases from Entropic Inference: Bayesian Networks beyond Optimal DAGs](https://arxiv.org/abs/2606.06440)
...
### [448] [Event Detection for Parameter-to-KPI Dependency Learning for AI-RAN](https://arxiv.org/abs/2606.06459)
...
### [449] [PC Layer: Polynomial Weight Preconditioning for Improving LLM Pre-Training](https://arxiv.org/abs/2606.06470)
...
### [450] [RREDCoT: Segment-Level Reward Redistribution for Reasoning Models](https://arxiv.org/abs/2606.06475)
...
### [451] [Pretraining Recurrent Networks without Recurrence](https://arxiv.org/abs/2606.06479)
...
### [452] [Regret Minimization with Adaptive Opponents in Repeated Games](https://arxiv.org/abs/2606.06486)
...
### [453] [TailLoR: Protecting Principal Components in Parameter-Efficient Continual Learning](https://arxiv.org/abs/2606.06494)
...
### [454] [Full-Field Calibration of Coupled Thermomechanical Material Models at Finite Strain](https://arxiv.org/abs/2606.05465)
...
### [455] [VITO: Vascular Geometry and Blood Flow Estimation Using Inverse Topology Optimization](https://arxiv.org/abs/2606.05487)
...
### [456] [AGI and the Limits of Value Production](https://arxiv.org/abs/2606.05715)
*Zichen Song*
...
### [457] [Modified augmented Lagrangian preconditioning for mixed-dimensional beam-solid coupling](https://arxiv.org/abs/2606.06035)
...
### [458] [Adaptation of the hybrid fictitious domain-immersed boundary method for Reynolds-averaged turbulence modeling](https://arxiv.org/abs/2606.06135)
...
### [459] [Data valuation model for non-monetary exchanges](https://arxiv.org/abs/2606.06325)
...
### [460] [Bridging CAD and Data-Driven Design: Attributed Feature Graphs for Engineering Design](https://arxiv.org/abs/2606.06405)
...
### [461] [Aggregating LLM-Based Weak Verifiers for Spatial Layout Generation](https://arxiv.org/abs/2606.05268)
*Sharon Zhang,R. Kenny Jones,Jiajun Wu,Maneesh Agrawala*

Main category: cs.GR

TL;DR: Use an LLM to write many imperfect layout-checking programs, combine them with weak learning and about 10 labeled examples, and you get a much stronger verifier than direct LLM judges, with up to 7x better F1 and 66.2% better guided generation quality.


<details>
  <summary>Details</summary>
Motivation: Directly using LLM judges to verify whether spatial layouts satisfy task descriptions is limited and unreliable. The paper is motivated by the need for a more accurate, scalable verifier for spatial layout domains such as 3D room layouts and 2D poster designs, while minimizing human labeling effort.

Method: The method asks an LLM to generate multiple task-specific verifier programs in a layout verification DSL. Each verifier acts as a weak checker for whether a layout matches a text description. The pipeline then aggregates the outputs of these weak verifiers into a strong verifier, learning aggregation weights or rules from a very small set of human-labeled layouts using weak-learning ideas. The resulting verifier can also provide natural-language feedback to guide layout generation.

Result: The strong verifier improves F1 scores by up to 7x over the status-quo of direct LLM judging across multiple 3D room layout and 2D poster design tasks. In addition, verifier-guided generation using feedback from the strong verifier improves the base layout generator’s quality by up to 66.2% according to human evaluation.

Conclusion: By synthesizing many task-specific weak verifier programs with an LLM and aggregating them using weak-learning techniques with only about 10 human-labeled examples, the proposed pipeline builds a strong verifier that substantially outperforms direct LLM judging for spatial layout tasks and also improves verifier-guided layout generation quality.
...
### [462] [The Invisible Hand of Physics: When Video Diffusion Models Know More Than They Show](https://arxiv.org/abs/2606.05328)
...
### [463] [Monte Carlo Steklov Operators for Large-Scale Geometry Processing in the Wild](https://arxiv.org/abs/2606.05581)
